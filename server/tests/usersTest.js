...
describe('User login', () => {
  ...
  test('401 status code for POST /api/login with wrong password', (done) => {
    return request(application)
      .post('/api/login')
...
describe('Find a specific user', () => {
  ...
  test('401 status code for GET /api/users/{user_id} without valid token', done => {
    return request(application)
  ...
  test('403 status code for GET /api/users/{user_id} without token', done => {
    return request(application)
      .get(`/api/users/${user_id}`)
      .then(response => {
...
describe('Update data on a user', () => {
  ...
  test('401 status code for PUT /api/users/{user_id} without valid token', (done) => {
    return request(application)
      .put(`/api/users/${user_id}`)
      .send(data)
  ...
  test('403 status code for PUT /api/users/{user_id} without token', (done) => {
    return request(application)
      .put(`/api/users/${user_id}`)
      .send(data)
      .then(response => {
...
describe('Change password', () => {
  ...
  test('401 status code for PUT /api/users/:user_id/password without valid token', done => {
    request(application)
      .put(`/api/users/${user_id}/password`)
      .send({
  ...
  test('403 status code for PUT /api/users/:user_id/password without token', done => {
    request(application)
      .put(`/api/users/${user_id}/password`)
      .send({
        old_password: "Passord123",
...
describe('Find all region subscriptions for a user', () => {
  ...
  test('401 status code for GET /api/users/:user_id/region_subscriptions without valid token', done => {
    return request(application)
  ...
  test('403 status code for GET /api/users/:user_id/region_subscriptions without token', done => {
    return request(application)
      .get(`/api/users/${user_id}/region_subscriptions`)
      .then(response => {
        expect(response.statusCode).toBe(403);
...
describe('Delete a user', () => {
  ...
  test('401 status code for DELETE /api/users/:user_id without valid token', done => {
    return request(application)
  ...
  test('403 status code for DELETE /api/users/:user_id without token', done => {
    return request(application)
      .delete(`/api/users/${user_id}`)
      .then(response => {
        expect(response.statusCode).toBe(403);
...
describe('Find all users registered in the system (only admins)', () => {
  test('401 status code for GET /api/users for non-admins', done => {
    request(application)
      .get('/api/users')
      .set('Authorization', `Bearer ${token}`)
      .then(response => {
  ...
  test('403 status code for GET /api/users without token', done => {
    request(application)
      .get('/api/users')
      .then(response => {
        expect(response.statusCode).toBe(403);
