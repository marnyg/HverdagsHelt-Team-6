...
class RegisterModal extends Component {
          ...
          <div className="registermodal-container modal-content">
            ...
            <form ref="form" className={'form-group'}>
              ...
              <small className="text-muted">
                Passord må inneholde store og små bokstaver pluss tall, og ha minst 8 tegn{' '}
              </small>
              <input
                type="password"
                ref="pass1"
  ...
  countyListener(event) {
    ...
    regionService
      .getAllRegionGivenCounty(county.value)
      .then((regions: Region[]) => {
  ...
  submit(event) {
    ...
    if (this.refs.form.checkValidity() && this.refs.pass1.value === this.refs.pass2.value) {
      ...
      let user = new User(
        null,
        null,
        Number(this.region_id),
        this.refs.fn.value,
        this.refs.ln.value,
        Number(this.refs.tlf.value),
      ...
      userService
        ...
        .then((user_out: User) => {
          ...
          userService
            .login(this.refs.email.value, this.refs.pass1.value)
            .then(res => {
